...
<head>
    <meta charset="UTF-8">
    <title>Surat Keterangan Kelahiran Laki-laki</title>
    <style>
...
<body>
    ...
    <div class="content">
        ...
        <div class="data-table">
            <table>
                <tr><td colspan="3"><strong>Data Bayi Laki-laki:</strong></td></tr>
                <tr><td>Nama</td><td>:</td><td><strong>{{ $namaAnak }}</strong></td></tr>
                <tr><td>Jenis Kelamin</td><td>:</td><td><strong>Laki-laki</strong></td></tr>
