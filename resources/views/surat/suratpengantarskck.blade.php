...
<body>
    @php
        ...
        $letterNumber = '400.12.2.2/' . $letterRequest->request_number . '/' . $romanMonth . '/' . $currentYear;
        
        // Data khusus
        $keperluan = $formData['keperluan'] ?? 'Pembuatan SKCK';
        $kepolisianTujuan = $formData['kepolisian_tujuan'] ?? 'Polsek setempat';
    @endphp
    ...
    <div class="content">
        ...
        <p>Orang tersebut diatas adalah benar warga Desa Ciasmara dan bermaksud untuk mengurus <strong>{{ $keperluan }}</strong> ke <strong>{{ $kepolisianTujuan }}</strong>.</p>
