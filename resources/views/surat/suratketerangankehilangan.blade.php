...
<body>
    ...
    <div class="content" style="text-align: justify">
        Nama tersebut diatas telah kehilangan {{ $surat->barang_hilang }} pada hari {{ $surat->hari_hilang }} tanggal {{ $surat->tanggal_hilang }} bulan {{ $surat->bulan_hilang }} tahun {{ $surat->tahun_hilang }}, Jam {{ $surat->waktu_hilang }} WIB, adapun lokasi kehilangan {{ $surat->lokasi_hilang }}.
    </div>
    <p></p>
    <div class="indent" style="text-align: justify">
        Demikian surat keterangan ini dibuat berdasarkan laporan yang bersangkutan pada hari {{ $surat->hari_lapor }} tanggal {{ \Carbon\Carbon::parse($surat->tanggal_lapor)->translatedFormat('d-m-Y') }}, untuk pihak terkait agar dapat mengetahui dan sebagai bahan lebih lanjut.
    </div>
