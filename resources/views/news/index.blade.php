<x-sidebar-layout>
    <x-slot name="title">Berita & Informasi</x-slot>
    <x-slot name="header">
        ...
        <div class="w-full mx-auto px-2 sm:px-4 lg:px-6">
            <div class="bg-white overflow-hidden shadow-sm rounded-lg">
                <div class="p-3 text-gray-900">
                    <div class="mb-4">
                        <h3 class="text-sm font-medium text-gray-900">Informasi Terkini Desa Ciasmara</h3>
                        <p class="mt-1 text-xs text-gray-600">
                            Informasi terbaru kegiatan dan pengumuman desa
                        </p>
                    </div>
