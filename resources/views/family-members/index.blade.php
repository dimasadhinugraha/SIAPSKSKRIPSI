                ...
                <div class="flex items-start">
                    ...
                    <div class="ml-3">
                        ...
                        <div class="text-sm text-blue-700 space-y-1">
                            <p>• Data anggota keluarga yang sudah disubmit <strong>tidak dapat diedit</strong> untuk menjaga integritas data.</p>
                            <p>• Pastikan semua informasi sudah benar sebelum menyimpan data.</p>
                            <p>• Jika ada kesalahan data, silakan hapus dan tambahkan ulang anggota keluarga.</p>
                            <p>• Data yang sudah disetujui dapat digunakan untuk pengajuan surat.</p>
                        </div>
                    </div>
                </div>
            </div>
